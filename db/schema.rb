...
ActiveRecord::Schema.define(version: 20190302111122) do
  ...
  create_table "likes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    t.integer  "likepost_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["likepost_id"], name: "index_likes_on_likepost_id", using: :btree
  ...
  add_foreign_key "likes", "microposts", column: "likepost_id"
